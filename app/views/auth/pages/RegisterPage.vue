...
const { isLoading, error, onSubmit, EUserType } = useRegisterForm();
</script>

<template>
  <div class="page-center" style="padding-bottom: 2rem; padding-top: 2rem">
    <div class="card container-sm">
      ...
      <div class="card-content">
        <div v-if="error" class="alert alert-destructive mb-md">
          {{ error }}
        </div>

        <form class="stack stack-md" @submit="onSubmit">
          <div class="grid-2">
          ...
          <div class="form-group">
            ...
            <Field name="userType" as="select" class="form-select">
              ...
              <option :value="EUserType.CUSTOMER">
                {{ t("AUTH_CUSTOMER") }}
              </option>
              <option :value="EUserType.SERVICE_PROVIDER">
                {{ t("AUTH_SERVICE_PROVIDER") }}
              </option>
            </Field>
